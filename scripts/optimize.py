...
if __name__ == '__main__':
    ...
    parser.add_argument('--knob_config_file', type=str,default='scripts/experiment/gen_knobs/moreworkloads/twitter_shap.json')
    parser.add_argument('--knob_num', type=int,default=52)
    ...
    parser.add_argument('--task_id', type=str, default="twitter_ddpg_52")
